...
def split():
    ...
    #Preparing Dataset
    train_data_list = train_death_videos + train_kill_videos + train_NoAction_videos + train_smoke_videos #+ train_t_videos
    ...
    val_data_list = val_death_videos + val_kill_videos + val_NoAction_videos + val_smoke_videos #+ val_t_videos
    ...
    test_data_list = test_death_videos + test_kill_videos + test_NoAction_videos + test_smoke_videos #+ test_t_videos
